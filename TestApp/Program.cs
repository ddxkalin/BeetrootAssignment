...
using UdpClient = Kalin.Utility.Concrete.UdpClient;
...
namespace UdpEchoClient
{
    class EchoClient : UdpClient
    {
        ...
        {
            Console.WriteLine($"UDP client connected a new session with Id {Id}");
        ...
        {
            Console.WriteLine($"UDP client disconnected a session with Id {Id}");
